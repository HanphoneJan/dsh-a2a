 ...
 *
 * tsdown emits the browser half as CJS (`lib/client.cjs`); the DSH web shell
 ...
 * body into that shape and writes `lib/client.js` (the file
 * `exports["./client"]` points at). The plugin id is read from package.json so
 * it always matches the published package name.
 */
